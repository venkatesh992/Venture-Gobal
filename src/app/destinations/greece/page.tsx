      ...
      <section className="relative -mt-[72px] flex min-h-[90svh] flex-col justify-end overflow-hidden pb-12">
        <div className="absolute inset-0">
          <Image
            ...
            sizes="100vw"
          />
          <div className="absolute inset-0 bg-gradient-to-b from-sky-950/30 via-sky-950/50 to-slate-950/95 mix-blend-multiply" />
      ...
      <section className="relative overflow-hidden bg-slate-950 py-16 md:py-20">
        <div className="container-custom relative z-10 text-center">
          ...
          <p className="mt-6 text-xl text-slate-300 max-w-2xl mx-auto font-light">
            Skip the generic job boards. Get placed directly into Greece's top resorts through Venture Global's exclusive network.
          </p>
          <div className="mt-10 flex flex-col sm:flex-row justify-center items-center gap-4">
            <Link
              href="/find-jobs?country=Greece"
              className="w-full sm:w-auto inline-flex items-center justify-center rounded-[var(--radius-md)] bg-sky-500 px-10 py-4 text-[16px] font-bold text-slate-900 shadow-xl transition-transform hover:scale-105"
            >
              Apply Now
            </Link>
            <Link
